...
namespace s3iLibTests
{
    ...
    public class UriExtensionsTest
    {
        ...
        public void Varieties()
        {
            ...
            Assert.AreEqual($"c:/folder/file.ext", fileUri.AbsolutePath);
            Assert.AreEqual($"c:/folder/file.ext", fileUri.GetAbsoluteFilePath());
            // Local file
            ...
            Assert.AreEqual($"c:/folder/file.ext", rootedFile.AbsolutePath);
            Assert.AreEqual($"c:/folder/file.ext", rootedFile.GetAbsoluteFilePath());
            // UNC
            ...
            Assert.AreEqual($"/folder/file.ext", unc.AbsolutePath);        
            Assert.AreEqual($"\\\\{unc.Host}/folder/file.ext", unc.GetAbsoluteFilePath());        
           // UNC file
            ...
            Assert.AreEqual($"/folder/file.ext", uncFile.AbsolutePath);
            Assert.AreEqual($"\\\\{unc.Host}/folder/file.ext", uncFile.GetAbsoluteFilePath());
