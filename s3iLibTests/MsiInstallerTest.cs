...
namespace s3iLibTests
{
    ...
    public class MsiInstallerTest
    {
        ...
        public void FormatInstallerCommandFromProductInfo()
        {
            ...
            Assert.AreEqual("msiKeys \"my temp\\product.msi\" Prop1=Value1 Prop2=\"Value 2\" msiArgs", MsiInstaller.FormatCommand(product.LocalPath, product.Props, "msiKeys", "msiArgs"));
        }
    }
}
